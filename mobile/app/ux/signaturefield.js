Ext.define('ux.signaturefield', {
	...
	config: {
         ...
         * @accessor
         */
		sigWidth:Ext.Viewport.getWindowHeight(),
		/**
         * @cfg {Number} sigHeight The height of the signature canvas object
         * @accessor
         */
		sigHeight:Ext.Viewport.getWindowWidth(),
		component: {
            xtype: 'panel'
        }
	}, 
	initialize: function(){
		...
		this.setSigWidth(windowWidth);
		this.setSigHeight(windowHeight);			
		...
		if (windowWidth > windowHeight) {
			...
			this.setSigWidth(windowHeight);
			this.setSigHeight(windowWidth);			
		}
		*/
		...
		this.actionOverlay = Ext.create('Ext.Panel', {
			...
			items:[this.actionOverlayCanvas,
			{
				xtype:'toolbar',
				docked:'bottom',
				items:[{xtype: 'spacer'},this.resetButton,this.saveButton,this.cancelButton,{xtype: 'spacer'}]
			}]
		});
		...
		this.cancelButton.element.on('tap', this.closeCanvasSheet, this);
	...
	openCanvasSheet: function() {
		this.actionOverlay.setWidth(Ext.Viewport.getWindowWidth());
		this.actionOverlay.setHeight(Ext.Viewport.getWindowHeight());
		this.loadCanvas(this.getValue());
		this.actionOverlay.show();
	},
	closeCanvasSheet: function() {
