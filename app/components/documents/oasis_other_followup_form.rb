class Documents::OasisOtherFollowupForm < Documents::AbstractOasisOtherFollowupForm
  ...
  def get_combo_box_values
    [["General Patient Information (M0010 - M0069)"],
     ...
     ["Clinical Record Items1 (M0080 - M0100)"],
