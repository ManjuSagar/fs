class Documents::OTFollowUpForm < Documents::AbstractDocumentForm
  ...
  js_method :init_component, <<-JS
    function(){
      ...
      var panelList = ["#pain_panel", "#ue_function_panel", "#functional_status_panel", "#functional_limitations_panel",
                   "#homebound_panel", "#equipment_panel", "#msc_panel", "#interventions_panel", "#education_panel", "#treatment_summary_panel"];
