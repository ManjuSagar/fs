class FieldStaffEditForm < Mahaswami::FormPanel
  def configuration
    c = super
    component_session[:field_staff_id] = c[:record_id] if c[:record_id]
    c.merge(
        model: "FieldStaff",
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            {name: :phone_number_2, field_label: '', flex: 1, label_width: 65, emptyText: 'Phone Number 2', input_mask: '999-99-9999', margin: "0 5px 0 0"},
