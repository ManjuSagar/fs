module Mahaswami
  class GridPanel < Netzke::Basepack::GridPanel
    include NetzkeBase
    include CheckboxModelPatch

  #edit_form_window_config class_name: "Mahaswami::ConfigurableRecordFormWindow"
  #add_form_window_config class_name: "Mahaswami::ConfigurableRecordFormWindow"
    ...
    def configuration
      super.merge({emptyText: 'No Records', enable_column_hide: false, infinite_scroll: true})
    end
