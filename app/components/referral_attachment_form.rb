class ReferralAttachmentForm < Mahaswami::FormPanel
  def configuration
    s = super
    s.merge(
        model: "TreatmentRequestAttachment",
        file_upload: true,
        items:[
            {name: :referral_received_date, field_label: "Date", xtype: 'datefield', value: TreatmentRequestAttachment.referral_date, dateFormat: 'Y-m-d', manually_required: true, item_id: :attachment_date},
