...
Ext.define('Ext.panel.IntegumentryStatus2M1308', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.integumentryStatus2M1308',
    border: false,
    margin: 5,
    items: [
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    html: "<b>COLUMN 2</b></br>Complete at</br> <b>FU & D/C</b>",
                    height: 55,
                    width: 200,
                    style: "text-align:center;",
                    border:false
                ...
                },
                {
                    ...
                    html: "<u>Number of those listed in column 1 that were present on admission (most recent SOC/ROC)</u>",
                    height: 78,
                    width: 200,
                    style: "text-align:center;",
                    border:false,
                ...
                },
                {
                    ...
                    xtype: "numberfield",
                    name: "m1308_nbr_stg2_at_soc_roc",
                    readOnly: true,
                    margin: "0 0 0 10px"
                },{
                ...
                },
                {
                    ...
                    xtype: "numberfield",
                    name: "m1308_nbr_stg3_at_soc_roc",
                    readOnly: true,
                    margin: "0 0 0 10px"
                ...
                },
                {
                    ...
                    xtype: "numberfield",
                    name: "m1308_nbr_stg4_at_soc_roc",
                    readOnly: true,
                    margin: "0 0 0 10px"
                },{
                ...
                },
                {
                    ...
                    xtype: "numberfield",
                    name: "m1308_nstg_deep_tisue_soc_roc",
                    readOnly: true,
                    margin: "0 0 0 10px"
                }
            ]
