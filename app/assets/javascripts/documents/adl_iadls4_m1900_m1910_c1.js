...
Ext.define('Ext.panel.AdlIadls4M1900M1910C1', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.adlIadls4M1900M1910C1',
    items: [
        {
            xtype: "panel",
            layout: "vbox",
            ...
            items: [
                    ...
                    items: [
                        {
                            ...
                            html:  "(M1900) Prior Functioning ADL/IADL: Indicate the patient's usual ability with everyday activities prior to " +
                                "his/her most recent illness, exacerbation, or injury. Check only <u>one</u> box in each row."
                        },
                        {
                            xtype: "panel",
                            border: false,
                            ...
                            items: [
                                ...
                                {
                                    html: 'a. Self-care (specifically: grooming, dressing, bathing and toileting hyginene)',
                                    width: 270,
                                    border:false
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'radiogroup',
                            fieldLabel: "(M1910) Has this patient had a multi-factor Falls Risk Assessment using a standardized, validated assessment tool?",
                            cls: 'oasis_blue',
