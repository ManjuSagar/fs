 ...
 */
Ext.define('Ext.panel.GeneralPatientInformationM0010M0140', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.generalPatientInformationM0010M0140',
    border: false,
    margin: 5,
    layout: "hbox",
    items: [
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'checkboxgroup',
                                    fieldLabel: '(M0140) Race/Ethnicity: (Mark all that apply.)',
                                    cls: 'oasis_blue',
                                    itemId: 'race_ethn',
                                    labelAlign: 'top',
                                    columns: 1,
                                    ...
                                    items: [
                                        {
                                            xtype: 'checkboxfield',
                                            name: "m0140_ethnic_ai_an",
                                            inputValue: "1",
                                            boxLabel: '1 - American Indian or Alaska Native'
                                        },
                                        {
                                            xtype: 'checkboxfield',
                                            name: "m0140_ethnic_asian",
                                            inputValue: "1",
                                            boxLabel: '2 - Asian'
                                        },
                                        {
                                            ...
                                            inputValue: "1",
                                            boxLabel: '3 - Black or African-American'
                                        },
                                        {
                                            xtype: 'checkboxfield',
                                            name: "m0140_ethnic_hisp",
                                            inputValue: "1",
                                            boxLabel: '4 - Hispanic or Latino'
                                        },
                                        {
                                            xtype: 'checkboxfield',
                                            name: "m0140_ethnic_nh_pi",
                                            inputValue: "1",
                                            boxLabel: '5 - Native Hawaiian or Pacific Islander'
                                        },
                                        {
                                            xtype: 'checkboxfield',
                                            name: "m0140_ethnic_white",
                                            inputValue: "1",
                                            boxLabel: '6 - White'
                                        }
                                    ]
    ...
    afterRender: function(){
        ...
        this.m0140EthnicityAiAn = this.mainScope.down("[name=m0140_ethnic_ai_an]");
        this.m0140EthnicityAsian = this.mainScope.down("[name=m0140_ethnic_asian]");
        this.m0140EthnicityBlack = this.mainScope.down("[name=m0140_ethnic_black]");
        this.m0140EthnicityHisp = this.mainScope.down("[name=m0140_ethnic_hisp]");
        this.m0140EthnicityPi = this.mainScope.down("[name=m0140_ethnic_nh_pi]");
        this.m0140EthnicityWhite = this.mainScope.down("[name=m0140_ethnic_white]");
        this.m0100AsstReason = this.mainScope.down("[name=m0100_assmt_reason]");
        this.m0010CCN = this.mainScope.down("[name=m0010_ccn]");
        this.m0014BranchState = this.mainScope.down("[name=m0014_branch_state]");
        this.m0016BranchId = this.mainScope.down("[name=m0016_branch_id]");
        ...
        this.refreshAgencyInfo.on('click', function(){
            this.mainScope.getAgencyInfo({}, function(res){
                ...
                this.m0016BranchId.setValue(res[2]);
            },this);
        },this);
    },
    ...
    onValidate: function(main){
        ...
        if(m0050PatSt.value == null || m0050PatSt.value==""){
            ...
            this.mainScope.checkForProperState({state_code: m0050PatSt.value}, function(res){
                if(res){
        ...
        if(m0060PatZip.value == null || m0060PatZip.value == "" ){
            ...
            this.mainScope.checkForProperZipCode({zip_code: m0060PatZip.value}, function(res){
                if(res){
        ...
        if(m0100AssessmentReason.value == '03'){
            if(m0032DateNaValue){
                errs.push(['M0032', "For main assessment Resumption of care date can't be NA."]);
            }
        ...
        if(m0032Date.value == null && m0032DateNaValue == false){
            errs.push(['M0032', "Enter the resumption of care date."]);
        ...
        //console.log("Value = " + main.m0016_branchId.value);
        //console.log("match = " + main.m0016_branchId.value.match(/^[\d[A-Z]]\{2\}Q[\d[A-Z]]\{4\}\d\{3\}/));
        ...
        if (!(this.m0140EthnicityAiAn.checked || this.m0140EthnicityAsian.checked || this.m0140EthnicityBlack.checked ||
            this.m0140EthnicityHisp.checked || this.m0140EthnicityPi.checked || this.m0140EthnicityWhite.checked)){
            errs.push(['M0140', "Select at least one Race/Ethnicity."]);
        }
    ...
    disableRocIfRequired: function(){
        this.m0100AsstReason.on('change', function(ele){
            if(ele.value == "01"){
                this.m0032Date.disable().setValue();
                this.m0032Na.disable().setValue(true);
            }else if(ele.value == "03"){
                this.m0032Na.disable().setValue(false);
            }
        }, this);
    },
    disableRocIfRequired: function(){
