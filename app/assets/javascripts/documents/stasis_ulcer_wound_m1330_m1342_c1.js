...
Ext.define('Ext.panel.StasisUlcerWoundM1330M1342C1', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.stasisUlcerWoundM1330M1342C1',
    border: false,
    items: [
        {
            xtype: "panel",
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'radiogroup',
                            fieldLabel: "(M1332) Current Number of Stasis Ulcer(s) that are Observable",
                            cls: 'oasis_green',
                        ...
                        {
                            xtype: 'radiogroup',
                            fieldLabel: "(M1334) Status of Most Problematic Surgical Wound that is Observable",
                            cls: 'oasis_green',
                ...
                },
                {
                    ...
                    items: [
                            ...
                            items: [
                                {
                                    ...
                                    margin: 5,
                                    boxLabel: '0 - No',
                                    afterBoxLabelTpl: '<text style="background-color:yellow"> [go to M1400]</text>'
                                },
                                {
                                    xtype: 'radiofield',
                                    name: "m1340_srgcl_wnd_prsnt",
                                ...
                                },
                                {
                                    ...
                                    inputValue: "02",
                                    margin: 5,
                                    boxLabel: '2 - Surgical wound known but not observable due to non-removable dressing/device',
                                    afterBoxLabelTpl: '<text style="background-color:yellow"> [go to M1400]</text>'
                                }
                            ]
                        },
                        {
                            xtype: 'radiogroup',
                            fieldLabel: "(M1342)  Status of Most Problematic Surgical Wound that is Observable",
                            cls: 'oasis_pink',
