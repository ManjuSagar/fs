...
Ext.define('Ext.panel.InterventionSynopsisM2400C1', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.interventionSynopsisM2400C1',
    border: false,
    items: [
        {xtype: 'label',
            margin: "10 5",
            html: "(M2400) Intervention Synopsis: (Check only <u>one</u> box in each row.) At the time of or at any time since the previous"+
        ...
        },
        {
            ...
            items: [
                ...
                {
                    html: "Every standardized, validated multi-factor fall risk assessment conducted at or since the last OASIS assessment indicates the patient has no risk for falls.",
                    width: 200,
                    height: 120,
                    border:false
                },
                ...
                {
                    html: "Patient has no diagnosis of depression AND every standardized, validated depression screening " +
                        "conducted at or since the last OASIS assessment indicates the patient has: 1) no symptoms of depression; " +
                        "or 2) has some symptoms of depression but does not meet criteria for further evaluation of depression based on screening tool used.",
                    width: 220,
                    height: 210,
                    border:false
                },
                ...
                {
                    html: "Every standardized, validated pain assessment conducted at or since the last OASIS assessment" +
                ...
                {
                    html: "Every standardized, validated pressure ulcer risk assessment conducted at or since the last " +
                        "OASIS assessment indicates the patient is not at risk of developing pressure ulcers.",
                    width: 200,
                    height:120,
                    border:false
                },
