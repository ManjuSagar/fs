...
Ext.define('Ext.panel.EmergentCareM2300M2310C1', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.emergentCareM2300M2310C1',
    border: false,
    items: [

        {
            xtype: 'radiogroup',
            fieldLabel: "(M2300) Emergent Care: At the time of or at any time since the previous OASIS assessment has the patient utilized a " +
