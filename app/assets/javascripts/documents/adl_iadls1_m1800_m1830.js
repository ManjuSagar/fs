...
Ext.define('Ext.panel.AdlIadls1M1800M1830', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.adlIadls1M1800M1830',
    items: [
        {
            xtype: 'radiogroup',
            layout: {
            ...
            fieldLabel: '(M1800) Grooming: Current ability to tend safely to personal hygiene needs (specifically: washing face and hands, hair care, shaving or make up, teeth or denture care, fingernail care). ',
            cls: 'oasis_blue',
            itemId: 'grooming1',
            width: "90%",
            labelAlign: 'top',
