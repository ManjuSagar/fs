...
Ext.define('Ext.panel.InpatientFacilityM2410M2440', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.inpatientFacilityM2410M2440',
    border: false,
    items: [
        {
            xtype: 'radiogroup',
            ...
            items: [
                ...
                },
                {
                    ...
                    inputValue: '03',
                    afterBoxLabelTpl: ' <text class="oasis_yellow">[Go to M2440]</text>'
                },
                {
                    xtype: 'radiofield',
                    name: 'm2410_inpat_facility',
        ...
        },
        {
            ...
            items: [
                {
                    ...
                    name: "m2430_hosp_med",
                    inputValue: "1",
                    boxLabel: '1 - Improper medication administration, medication side effects, toxicity, anaphylaxis'
                },
                {
                    xtype: 'checkboxfield',
                ...
                },
                {
                    ...
                    inputValue: "1",
                    boxLabel: '3 - Respiratory infection (e.g., pneumonia, bronchitis)'
                },
                {
                    xtype: 'checkboxfield',
                ...
                },
                {
                    ...
                    inputValue: "1",
                    boxLabel: '5 - Heart failure (e.g., fluid overload)'
                },
                {
                    xtype: 'checkboxfield',
            ...
            xtype: 'checkboxgroup',
            fieldLabel: '(M2440) For what Reason(s) was the patient Admitted to a Nursing Home? (Mark all that apply.)',
            labelAlign: 'top',
            columns: 1,
            ...
            items: [
                {
                    xtype: 'checkboxfield',
                    name: "m2440_nh_therapy",
                    inputValue: "1",
                    boxLabel: '1 - Therapy services'
                },
                {
                    xtype: 'checkboxfield',
                    name: "m2440_nh_respite",
                    inputValue: "1",
                    boxLabel: '2 - Respite care'
                },
                {
                    xtype: 'checkboxfield',
                    name: "m2440_nh_hospice",
                    inputValue: "1",
                    boxLabel: '3 - Hospice care'
                },
                {
                    xtype: 'checkboxfield',
                    name: "m2440_nh_permanent",
                    inputValue: "1",
                    boxLabel: '4 - Permanent placement'
                },
                {
                    xtype: 'checkboxfield',
                    name: "m2440_nh_unsafe_home",
                    inputValue: "1",
                    boxLabel: '5 - Unsafe for care at home'
                },
                {
                    xtype: 'checkboxfield',
                    name: "m2440_nh_other",
    ...
    afterRender: function(){
        ...
        this.reasons = ['m2440_nh_therapy', 'm2440_nh_respite', 'm2440_nh_hospice', 'm2440_nh_permanent', 'm2440_nh_unsafe_home',
            'm2440_nh_other', 'm2440_nh_unknown']
        this.validReasons = ['m2440_nh_therapy', 'm2440_nh_respite', 'm2440_nh_hospice', 'm2440_nh_permanent', 'm2440_nh_unsafe_home',
            'm2440_nh_other']
        this.reasonUK = this.down("[name=m2440_nh_unknown]");
        Ext.each(this.validReasons, function(reason, index){
            this.down("[name="+reason+"]").on('change', function(ele){
                if(ele.value){
                    this.reasonUK.setValue(false);
                }
            }, this);
        }, this);

        this.reasonUK.on('change', function(ele){
            Ext.each(this.validReasons, function(reason, index){
                if(ele.value){
                    this.down("[name="+reason+"]").setValue(false);
                }
            }, this);
        }, this);
        ...
        this.super_main.query("[name = m2410_inpat_facility]").forEach(function(s){
            s.on('change', function(el){
                if(el.getGroupValue() == "02" || el.getGroupValue() == "04"){
                    ...
                    Ext.each(this.reasons, function(element){
                        this.super_main.down('[name='+element+']').disable().setValue(false);
                    },this);
                }else{
                    Ext.each(this.hospitals, function(element){
    ...
    onValidate: function(){
        ...
        var reasons = ['m2440_nh_therapy', 'm2440_nh_respite', 'm2440_nh_hospice', 'm2440_nh_permanent', 'm2440_nh_unsafe_home',
            'm2440_nh_other', 'm2440_nh_unknown']
        var reasonSelected = false;
        Ext.each(reasons, function(field, index){
            reasonSelected = reasonSelected || (this.down("[name="+field+"]").value != false);
        }, this);

        var m0100Value = this.super_main.down("[name=m0100_assmt_reason]").value;
        if((m0100Value == "06" || m0100Value == "07") && (m2410InpatFacility && m2410InpatFacility.getGroupValue() == "03") && !reasonSelected){
            errs.push(['M2440', "Select at least one option from the reason(s) the patient admitted to a Nursing Home."]);
        }
