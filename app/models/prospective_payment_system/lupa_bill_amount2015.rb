class ProspectivePaymentSystem::LupaBillAmount2015 < ProspectivePaymentSystem::LupaBillAmount
  ADD_ON_AMOUNT_PERCENT = {:SN => 84.51, :ST => 62.66, :PT => 67}

  def lupa_add_on_amount(discipline_code)
    base_rate = lupa_discipline_rates(2015).find_by_discipline_code(discipline_code).base_amt
