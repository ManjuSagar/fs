                            ...
                            items: [
                                {
                                    ...
                                    title: 'Diagnosis/Medications/DME/Nutritional Req.',
                                    items: [
                                        {
                                            xtype: 'panel',
                                            flex: 1,
                                ...
                                },
                                {
                                    ...
                                    title: 'Limitations/Activities/Status',
                                    items: [
                                        {
                                            xtype: 'panel',
                                            border: 0,
                                ...
                                },
                                {
                                    ...
                                    title: 'Safety Measures/Orders/Goals',
                                    items: [
                                        {
                                            xtype: 'fieldset',
                                            margin: '7px',
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    margin: '3px',
                                                    name: 'orders',
                                                    fieldLabel: 'Orders for Discipline and Treatments (Specify Amount/Frequency/Duration) ',
                                                    labelAlign: 'top',
                                                    cols: 100
                                                },
                                                {
                                                    ...
                                                    margin: '3px',
                                                    name: 'goals',
                                                    fieldLabel: 'Goals/Rehabilitation Potential/Discharge Plans ',
                                                    labelAlign: 'top',
                                                    cols: 100
                                                }
                                            ]
