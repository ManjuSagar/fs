...
#insurance_companies = CSV.readlines("#{Rails::root}/static_data/committed_agency_setup/insurance_companies.csv", :headers => true, skip_blanks: true)
#physicians = CSV.readlines("#{Rails::root}/static_data/agency_setup/physicians.csv", :headers => true, skip_blanks: true)

field_staffs =  CSV.readlines("#{Rails::root}/static_data/agency_setup/committed_field_saff.csv", :headers=>true, skip_blanks: true)
...
ActiveRecord::Base.transaction do
  ...
  email = is_production ? "committed@comcast.net" : get_email("comcast")
  agency_num = "106"
  health_agency = HealthAgency.new
  health_agency.org_name = "Committed Home Health Care, LLC"
  health_agency.org_type = "HealthAgency"
  health_agency.org_package = 'P'
  health_agency.week_start_day = 'MON'
  health_agency.suite_number = "400"
  health_agency.street_address = "15800 Providence DR"
  health_agency.city = "Southfield"
  health_agency.state = 'MI'
  health_agency.zip_code = "48075"
  health_agency.preferred_alert_mode = 'E'
  health_agency.email = "committed@comcast.net"
  health_agency.phone_number = "(248) 443-8044"
  health_agency.fax_number = "(248) 443-8033"
  health_agency.fed_tax_number = "264220257"
  #health_agency.npi_number = "1234567890"
  health_agency.primary_contact_first_name = "CHHA"
  health_agency.primary_contact_last_name = "Admin"
  health_agency.primary_contact_email = email
  health_agency.primary_contact_phone_number = "(248) 443-8044"
  ...
  health_agency_detail.cms_cert_number = "239040"
  health_agency_detail.npi_number = "1407095706"
  health_agency_detail.health_agency_id = health_agency.id
  health_agency_detail.submitter_id = "HHWIA017316"
